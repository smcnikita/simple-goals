          ...
          <form>
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <Button type="button" variant="outline" className="w-full" onClick={async () => await signIn('yandex')}>
                  <Image src="/img/yandex.png" alt="Yandex logo" width={16} height={16} />
                  Login with Yandex
                </Button>
                <Button type="button" variant="outline" className="w-full" onClick={async () => await signIn('github')}>
